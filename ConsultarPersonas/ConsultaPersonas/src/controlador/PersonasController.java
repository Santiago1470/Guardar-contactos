...
public class PersonasController implements ActionListener {
	...
	public void iniciar() {
		 ...
		 * "Ingrese por favor la URL de la base de datos:"); String user =
		 * JOptionPane.showInputDialog(null,
		 * "Ingrese por favor el usuario de la base de datos:"); String password =
		 * JOptionPane.showInputDialog(null,
		 * "Ingrese por favor la contraseña del usuario de la base de datos:");
		 * 
		 * this.daoPersonaImpl.setURL(URL); this.daoPersonaImpl.setUser(user);
		...
		// correctamente.");
		if (daoPersonaImpl.estadoConexion()) {
			...
			try {
				...
				if (persona == null) {
					JOptionPane.showMessageDialog(null,
							"La persona consultada con " + datos[0] + ": " + datos[1] + " no existe.");
					limpiarCampos();
					existe = false;
				} else {
					existe = true;
